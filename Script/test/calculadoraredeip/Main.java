...
public class Main {
	...
	public static void main(String[] args) {
		...
		switch(opcao){
			case 1:
				System.out.println("IDENTIFICA��O DE ENDERE�O PADR�O\n================================");
				...
				break;
			case 2:
				System.out.println("IDENTIFICA��O DE ENDERE�O COM M�SCARA\n=====================================");
				if(enderecoIP.validarIP()){
					calculadora.informarClasse(enderecoIP.getPrimeiroCampoDecimal(), enderecoIP.getSegundoCampoDecimal());
					String mascara;
				...
				break;
			case 3:
				System.out.println("C�LCULO DE BLOCO\n================================");
				if(enderecoIP.validarIP()){
					calculadora.informarClasse(enderecoIP.getPrimeiroCampoDecimal(), enderecoIP.getSegundoCampoDecimal());
				...
				break;
			case 4:
				System.out.println("C�LCULO DE SUB-REDES\n=====================================");
				if(enderecoIP.validarIP()){
					calculadora.informarClasse(enderecoIP.getPrimeiroCampoDecimal(), enderecoIP.getSegundoCampoDecimal());
					String mascara;
					System.out.println("Insira uma m�scara:");
